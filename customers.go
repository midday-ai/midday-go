...
func newCustomers(rootSDK *Midday, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Customers {
	return &Customers{
		rootSDK:          rootSDK,
...
func (s *Customers) List(ctx context.Context, q *string, sort []string, cursor *string, pageSize *float64, opts ...operations.Option) (*operations.ListCustomersResponse, error) {
...
func (s *Customers) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetCustomerByIDResponse, error) {
	...
	res := &operations.GetCustomerByIDResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetCustomerByIDResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Customers) Delete(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteCustomerResponse, error) {
...
func (s *Customers) Update(ctx context.Context, id string, requestBody *operations.UpdateCustomerRequestBody, opts ...operations.Option) (*operations.UpdateCustomerResponse, error) {
