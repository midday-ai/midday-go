...
<!-- UsageSnippet language="go" operationID="startTimer" method="post" path="/tracker-entries/timer/start" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="stopTimer" method="post" path="/tracker-entries/timer/stop" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="getCurrentTimer" method="get" path="/tracker-entries/timer/current" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="getTimerStatus" method="get" path="/tracker-entries/timer/status" -->
```go
package main
