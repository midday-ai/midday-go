...
func main() {
    ...
    res, err := s.Invoices.Create(ctx, operations.CreateInvoiceRequest{
        ...
        DueDate: types.MustNewTimeFromString("2024-07-15T23:59:59.000Z"),
        IssueDate: types.MustNewTimeFromString("2024-06-15T00:00:00.000Z"),
...
<!-- UsageSnippet language="go" operationID="getInvoicePaymentStatus" method="get" path="/invoices/payment-status" -->
```go
package main
...
func main() {
    ...
    res, err := s.Invoices.PaymentStatus(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
**[*operations.GetInvoicePaymentStatusResponse](../../models/operations/getinvoicepaymentstatusresponse.md), error**
...
func main() {
    ...
    res, err := s.Invoices.Summary(ctx, []operations.GetInvoiceSummaryStatus{
        operations.GetInvoiceSummaryStatusDraft,
        operations.GetInvoiceSummaryStatusUnpaid,
    })
    if err != nil {
        log.Fatal(err)
    }
