...
<!-- UsageSnippet language="go" operationID="listTrackerEntries" method="get" path="/tracker-entries" -->
```go
package main
...
func main() {
    ...
    res, err := s.TrackerEntries.List(ctx, "2024-04-01", "2024-04-30", middaygo.Pointer("b3b6e2c2-1f2a-4e3b-9c1d-2a4b6e2c21f2"))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
<!-- UsageSnippet language="go" operationID="createTrackerEntry" method="post" path="/tracker-entries" -->
```go
package main
...
func main() {
    ...
    res, err := s.TrackerEntries.Create(ctx, &operations.CreateTrackerEntryRequest{
        ...
        Description: middaygo.Pointer("Worked on implementing user authentication feature"),
        Duration: 28800,
    })
    if err != nil {
        log.Fatal(err)
...
<!-- UsageSnippet language="go" operationID="createTrackerEntriesBulk" method="post" path="/tracker-entries/bulk" -->
```go
package main
    ...
    res, err := s.TrackerEntries.CreateBulk(ctx, &operations.CreateTrackerEntriesBulkRequest{
        Entries: []operations.Entry{
            operations.Entry{
                ...
                AssignedID: middaygo.Pointer("a1b2c3d4-e5f6-7890-abcd-ef1234567890"),
                ProjectID: "b3b6e2c2-1f2a-4e3b-9c1d-2a4b6e2c21f2",
                Description: middaygo.Pointer("Working on authentication feature"),
                Duration: 28800,
            },
            operations.Entry{
                ...
                AssignedID: middaygo.Pointer("a1b2c3d4-e5f6-7890-abcd-ef1234567890"),
                ProjectID: "b3b6e2c2-1f2a-4e3b-9c1d-2a4b6e2c21f2",
                Description: middaygo.Pointer("Working on dashboard feature"),
                Duration: 28800,
            },
        },
    })
...
<!-- UsageSnippet language="go" operationID="deleteTrackerEntry" method="delete" path="/tracker-entries/{id}" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="updateTrackerEntry" method="patch" path="/tracker-entries/{id}" -->
```go
package main
