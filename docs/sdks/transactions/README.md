...
func main() {
    ...
    res, err := s.Transactions.List(ctx, operations.ListTransactionsRequest{
        ...
        PageSize: middaygo.Pointer[float64](50),
        Q: middaygo.Pointer("office supplies"),
        Categories: []string{
            "office-supplies",
            "travel",
        },
        ...
        Start: middaygo.Pointer("2024-04-01T00:00:00.000Z"),
        End: middaygo.Pointer("2024-04-30T23:59:59.999Z"),
        Accounts: []string{
            "account-1",
            "account-2",
        },
        ...
        AmountRange: []*float64{
            middaygo.Pointer[float64](100),
            middaygo.Pointer[float64](1000),
        },
        Amount: []string{
            "150.75",
            "299.99",
...
func main() {
    ...
    res, err := s.Transactions.GetAttachmentPreSignedURL(ctx, "b3b7c1e2-4c2a-4e7a-9c1a-2b7c1e24c2a4", "a43dc3a5-6925-4d91-ac9c-4c1a34bdb388", middaygo.Pointer(true))
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
