...
func main() {
    ...
    res, err := s.Reports.Revenue(ctx, "2023-01-01", "2023-12-31", middaygo.String("USD"), operations.GetRevenueReportsRevenueTypeNet.ToPointer())
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Reports.Profit(ctx, "2023-01-01", "2023-12-31", middaygo.String("USD"), operations.GetProfitReportsRevenueTypeNet.ToPointer())
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    if res.GetBurnRateResponseSchema != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.Reports.Runway(ctx, middaygo.String("USD"))
    if err != nil {
        log.Fatal(err)
    }
