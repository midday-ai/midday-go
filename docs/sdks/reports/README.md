...
func main() {
    ...
    res, err := s.Reports.Revenue(ctx, "2023-01-01", "2023-12-31", middaygo.Pointer("USD"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Reports.Profit(ctx, "2023-01-01", "2023-12-31", middaygo.Pointer("USD"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Reports.BurnRate(ctx, "2023-01-01", "2023-12-31", middaygo.Pointer("USD"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Reports.Runway(ctx, "2023-01-01", "2023-12-31", middaygo.Pointer("USD"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Reports.Expenses(ctx, "2023-01-01", "2023-12-31", middaygo.Pointer("USD"))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Reports.Spending(ctx, "2023-01-01", "2023-12-31", middaygo.Pointer("USD"))
    if err != nil {
        log.Fatal(err)
    }
